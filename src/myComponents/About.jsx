    ...
    <div id="about" className="mt-10">
      <div className="flex  md:flex md:justify-evenly md:p-5">
        <div className="   flex flex-col justify-center   ">
          <h1 className="        md:font-sans md:text-2xl md:font-bold">
            Find the books you are reading <br />
            for the read
          </h1>

          <input
            className="w-fit rounded-lg border-2 border-black mt-2 text-center"
            type="text"
      ...
      <div className="  sm:w-[250px] items-center justify-center text-center   md:w-[100%] md:flex md:justify-center md:items-center flex-col text-lg  font-sans ">
        <h1 className=" md:font-bold md:flex md:justify-center">
          Faisal-Akram Books-Store
        </h1>
